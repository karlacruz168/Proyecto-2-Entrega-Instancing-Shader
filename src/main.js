...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // --- REQUISITO 1: 100 agentes configurados para InstancedMesh ---
    ...
    // --- REQUISITO 2: Shader Avanzado Personalizado ---
    ...
    // Iniciamos la animación una vez configurado todo con éxito
    animate();
});